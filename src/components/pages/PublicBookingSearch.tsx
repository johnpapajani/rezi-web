...
const PublicBookingSearch: React.FC = () => {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.detail || 'Failed to find booking. Please check your booking ID and phone number.');
      setBooking(null);
    } finally {
      setLoading(false);
    }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-6">Search for Your Booking</h2>
        ...
        {hasSearched && !booking && !error && !loading && (
          <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4 mb-6">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-yellow-800">No booking found</h3>
                <div className="mt-2 text-sm text-yellow-700">
                  Please check your booking ID and phone number and try again.
                </div>
              </div>
            </div>
          </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900">{booking.service_duration_min} minutes</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900">{booking.party_size} {booking.party_size === 1 ? 'person' : 'people'}</p>
                        </div>
                      </div>
                      ...
                      {booking.table_code && (
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="font-medium text-gray-900">{booking.table_code} ({booking.table_seats} seats)</p>
                          </div>
                        </div>
                      )}
                    </div>
              ...
              {booking.status !== 'cancelled' && !canCancelBooking(booking) && (
                <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-md">
                  <div className="flex">
                    <ExclamationTriangleIcon className="h-5 w-5 text-yellow-400" />
                    <div className="ml-3">
                      <h3 className="text-sm font-medium text-yellow-800">Cancellation Notice</h3>
                      <div className="mt-2 text-sm text-yellow-700">
                        This booking cannot be cancelled as it's less than 1 hour before the start time or has already taken place.
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
            <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
              <div className="mt-3 text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mt-2">Cancel Booking</h3>
